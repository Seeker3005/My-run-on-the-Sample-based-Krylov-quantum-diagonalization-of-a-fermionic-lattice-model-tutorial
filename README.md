...
This is my run of the "Sample-based Krylov quantum diagonalization of a fermionic lattice model" tutorial provided by IBM Quantum Platform Tutorials. I mostly kept the notebook unchanged. In sample-based-krylov-quantum-diagonalization.html, you can see the outputs I obtained when running the code. This repository is meant to show that I have completed a tutorial project and have run a real algorithm on a quantum device.
